<script lang="ts">
	...
	const hasGif = !!data.project?.gifUrl;
	...
	{:else}
		<div class="flex flex-col items-center overflow-x-hidden">
			...
			<div class="pt-3 pb-1 overflow-x-hidden w-full">
				...
				{#if hasGif}
					<div class="px-10px col-center gap-3 m-t-10">
						<div class="gif-container w-100% max-w-[800px] aspect-video rounded-10px overflow-hidden">
							<img src={data.project.gifUrl} alt="Project GIF" class="w-100% h-100% object-contain" />
						</div>
						<p class="text-[var(--tertiary-text)] font-300">Project Demo</p>
					</div>
				...
				{:else}
					<div class="p-5 col-center gap-3 m-y-auto text-[var(--border)]">
						...
						<p class="font-300">No screenshots or GIF</p>
					</div>
				{/if}
			</div>
		</div>
